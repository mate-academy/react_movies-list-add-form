...
export const NewMovie: React.FC<Props> = ({ submitMovie }) => {
  ...
  return (
    ...
    >
      Input all information about movie
      <input
        name="title"
        placeholder="Please, enter muvie title"
      ...
      <input
        name="description"
        placeholder="Please, enter muvie description"
      ...
      <input
        name="imgUrl"
        placeholder="Please, enter muvie ImgUrl"
      ...
      <input
        name="imdbUrl"
        placeholder="Please, enter muvie ImdbUrl"
      ...
      <input
        name="imdbId"
        placeholder="Please, enter muvie ImdbId"
