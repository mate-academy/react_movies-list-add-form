...
NewMovie.propTypes = {
  ...
  // newImdbUrl: PropTypes.string.isRequired,
  // newImdbID: PropTypes.string.isRequired,
  // buttonDisabled: PropTypes.bool.isRequired,
  // isTitleValid: PropTypes.bool.isRequired,
  // isImgUrlValid: PropTypes.bool.isRequired,
  // isImdbUrlValid: PropTypes.bool.isRequired,
  // isImdbIDValid: PropTypes.bool.isRequired,
};
