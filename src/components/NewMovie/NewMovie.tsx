...
export const NewMovie: React.FC<Props> = ({onAdd}) => {
  ...
  const reset = () => {
    ...
    const isDisabled = !title.trim() || !imgUrl.trim() || !imdbUrl.trim() || !imdbId.trim();
  ...
  return (
    ...
    onSubmit={handleSubmit}>
      ...
      <TextField name="description" label="Description" value={description} onChange={setDescription} required = {false}/>
